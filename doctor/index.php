    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" novalidate method="POST" action="functionality/doctorloginact.php">
                ...
                <label for="">Not a registered Doctor ? </label>
                <br>
                <label for="">Contact Your Hospital!!</label>
            </div>
        </div>

        <footer class="my-5 pt-5 text-muted text-center text-small">
            <p class="mb-1">&copy; 2020 Johnnie Coder</p> <br> <a href="../index.php">HOME</a>
